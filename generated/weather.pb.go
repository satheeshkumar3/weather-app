...
type WeatherRequest struct {
	...
	City string `protobuf:"bytes,1,opt,name=city,proto3" json:"city,omitempty"` // The name of the city
}
...
type WeatherResponse struct {
	...
	City        string  `protobuf:"bytes,1,opt,name=city,proto3" json:"city,omitempty"`                 // The name of the city
	Description string  `protobuf:"bytes,2,opt,name=description,proto3" json:"description,omitempty"`   // Description of the weather (e.g., "Sunny")
	Temperature float32 `protobuf:"fixed32,3,opt,name=temperature,proto3" json:"temperature,omitempty"` // Temperature in Celsius
}
...
var file_weather_proto_rawDesc = []byte{
	...
	0x04, 0x63, 0x69, 0x74, 0x79, 0x22, 0x69, 0x0a, 0x0f, 0x57, 0x65, 0x61, 0x74, 0x68, 0x65, 0x72,
	0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x12, 0x0a, 0x04, 0x63, 0x69, 0x74, 0x79,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x63, 0x69, 0x74, 0x79, 0x12, 0x20, 0x0a, 0x0b,
	...
	0x32, 0x41, 0x0a, 0x0e, 0x57, 0x65, 0x61, 0x74, 0x68, 0x65, 0x72, 0x53, 0x65, 0x72, 0x76, 0x69,
	0x63, 0x65, 0x12, 0x2f, 0x0a, 0x0a, 0x47, 0x65, 0x74, 0x57, 0x65, 0x61, 0x74, 0x68, 0x65, 0x72,
	0x12, 0x0f, 0x2e, 0x57, 0x65, 0x61, 0x74, 0x68, 0x65, 0x72, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73,
	0x74, 0x1a, 0x10, 0x2e, 0x57, 0x65, 0x61, 0x74, 0x68, 0x65, 0x72, 0x52, 0x65, 0x73, 0x70, 0x6f,
	0x6e, 0x73, 0x65, 0x42, 0x31, 0x5a, 0x2f, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f,
	0x6d, 0x2f, 0x73, 0x61, 0x74, 0x68, 0x65, 0x65, 0x73, 0x68, 0x6b, 0x75, 0x6d, 0x61, 0x72, 0x33,
	0x2f, 0x77, 0x65, 0x61, 0x74, 0x68, 0x65, 0x72, 0x2d, 0x61, 0x70, 0x70, 0x2f, 0x67, 0x65, 0x6e,
...
var file_weather_proto_depIdxs = []int32{
	...
	1, // 1: WeatherService.GetWeather:output_type -> WeatherResponse
